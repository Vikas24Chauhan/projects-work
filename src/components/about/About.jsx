    ...
    <div className="about-section">
      <div className="about-content">
        ...
        <p>
          ...
          management, and modern development tools like Git and Vite. Passionate
          about clean code and performance optimization, I continuously work on
          improving my skills and building efficient, user-centric digital
          solutions.
        </p>
      </div>
    </div>
